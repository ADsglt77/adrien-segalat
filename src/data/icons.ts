...
export const iconLinux = 'devicon:linux'
export const iconTypeScript = 'devicon:typescript'
export const iconPhotoshop = 'devicon:photoshop'
export const iconBdd = 'devicon:azuresqldatabase'
...
export const iconDart = 'devicon:dart'
export const iconAndroid = 'devicon:android'
export const iconMysql = 'devicon:mysql'

// Actions (iconoir)
export const iconPdf = 'iconoir:file-pdf'
export const iconLink = 'iconoir:link'
export const iconGithubAction = 'iconoir:github'
export const iconPlay = 'iconoir:play'
